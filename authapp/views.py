...
from .models import Contact,MembershipPlan,Trainer,Enrollment,Gallery,Attendance,GymLocation, GymInstructor
...
def attendance(request):
    ...
    if request.method=='POST':
        ...
        query.save()
        messages.warning(request,"Attendance Appllied Success")
...
def signup(request):
    if request.method=="POST":
        ...
        # messages.success("User Is Created Please Login success")
        return redirect('/login')
...
def about(request):
    ...
    instructors = GymInstructor.objects.all()
    return render(request,"about.html", {'locations': locations, 'instructors': instructors})